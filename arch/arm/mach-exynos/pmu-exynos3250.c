...
static struct exynos_pmu_conf exynos3250_pmu_config[] = {
	...
	{ EXYNOS3_TOP_ASB_RESET_SYS_PWR_REG,			{ 0x1, 0x1, 0x1} },
	{ EXYNOS3_TOP_ASB_ISOLATION_SYS_PWR_REG,		{ 0x1, 0x1, 0x1} },
	{ EXYNOS3_TOP_ASB_RESET_COREBLK_SYS_PWR_REG,		{ 0x1, 0x1, 0x0} },
	{ EXYNOS3_TOP_ASB_ISOLATION_COREBLK_SYS_PWR_REG,	{ 0x1, 0x1, 0x1} },
...
void exynos3250_cpu_up(unsigned int cpu_id)
{
	unsigned int tmp;
	void __iomem *addr;

	addr = EXYNOS_ARM_CORE_CONFIGURATION(cpu_id);
...
void exynos3250_cpu_down(unsigned int cpu_id)
{
	unsigned int tmp;
	void __iomem *addr;
...
unsigned int exynos3250_cpu_state(unsigned int cpu_id)
{
	unsigned int val;

	val = __raw_readl(EXYNOS_ARM_CORE_STATUS(cpu_id))
...
int __init exynos3250_pmu_init(void)
{
	unsigned int value;

	exynos_cpu.power_up = exynos3250_cpu_up;
	exynos_cpu.power_state = exynos3250_cpu_state;
	exynos_cpu.power_down = exynos3250_cpu_down;
