...
#define EXYNOS5430_PA_SYSRAM_NS		0x02073000
...
#define EXYNOS5430_VA_CMU_KFC		(S5P_VA_CMU + (SZ_4K * 2))
#define EXYNOS5430_VA_CMU_AUD		(S5P_VA_CMU + (SZ_4K * 3))
#define EXYNOS5430_VA_CMU_BUS1		(S5P_VA_CMU + (SZ_4K * 4))
#define EXYNOS5430_VA_CMU_BUS2		(S5P_VA_CMU + (SZ_4K * 5))
#define EXYNOS5430_VA_CMU_CAM0		(S5P_VA_CMU + (SZ_4K * 6))
#define EXYNOS5430_VA_CMU_CAM0_LOCAL	(S5P_VA_CMU + (SZ_4K * 7))
#define EXYNOS5430_VA_CMU_CAM1		(S5P_VA_CMU + (SZ_4K * 8))
#define EXYNOS5430_VA_CMU_CAM1_LOCAL	(S5P_VA_CMU + (SZ_4K * 9))
#define EXYNOS5430_VA_CMU_CPIF		(S5P_VA_CMU + (SZ_4K * 10))
#define EXYNOS5430_VA_CMU_DISP		(S5P_VA_CMU + (SZ_4K * 11))
#define EXYNOS5430_VA_CMU_FSYS		(S5P_VA_CMU + (SZ_4K * 12))
#define EXYNOS5430_VA_CMU_G2D		(S5P_VA_CMU + (SZ_4K * 13))
#define EXYNOS5430_VA_CMU_G3D		(S5P_VA_CMU + (SZ_4K * 14))
#define EXYNOS5430_VA_CMU_GSCL		(S5P_VA_CMU + (SZ_4K * 15))
#define EXYNOS5430_VA_CMU_HEVC		(S5P_VA_CMU + (SZ_4K * 16))
#define EXYNOS5430_VA_CMU_IMEM		(S5P_VA_CMU + (SZ_4K * 17))
#define EXYNOS5430_VA_CMU_ISP		(S5P_VA_CMU + (SZ_4K * 18))
#define EXYNOS5430_VA_CMU_ISP_LOCAL	(S5P_VA_CMU + (SZ_4K * 19))
#define EXYNOS5430_VA_CMU_MFC0		(S5P_VA_CMU + (SZ_4K * 20))
#define EXYNOS5430_VA_CMU_MFC1		(S5P_VA_CMU + (SZ_4K * 21))
#define EXYNOS5430_VA_CMU_MIF		(S5P_VA_CMU + (SZ_4K * 22))
#define EXYNOS5430_VA_CMU_MSCL		(S5P_VA_CMU + (SZ_4K * 23))
#define EXYNOS5430_VA_CMU_PERIC		(S5P_VA_CMU + (SZ_4K * 24))
#define EXYNOS5430_VA_CMU_PERIS		(S5P_VA_CMU + (SZ_4K * 25))
