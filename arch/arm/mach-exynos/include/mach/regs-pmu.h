...
#define S5P_MIPI_DPHY_CONTROL(n)		((soc_is_exynos5250() || soc_is_exynos5430()) ? \
...
#define EXYNOS5422_PAD_RETENTION_DRAM_SYS_PWR_REG		EXYNOS_PMUREG(0x1210)
...
#define EXYNOS5422_CMU_SYSCLK_SYSMEM_TOPPWR_SYS_PWR_REG		EXYNOS_PMUREG(0x14F4)
...
#define EXYNOS5422_SFR_AXI_CGDIS1_REG				EXYNOS_PMUREG(0x15E4)
#define EXYNOS5422_FSYS2_OPTION_REG				EXYNOS_PMUREG(0x4168)
#define EXYNOS5422_PSGEN_OPTION_REG				EXYNOS_PMUREG(0x4188)

#define EXYNOS5422_USE_RETENTION				(1<<3)
#define EXYNOS5422_EMULATION					(1<<31)
#define EXYNOS5422_UFS						(1<<8)
#define EXYNOS5422_ACE_KFC					(1<<14)
#define EXYNOS5422_ACE_EAGLE					(1<<15)
#define EXYNOS5422_ATB_ISP_ARM					(1<<19)
#define EXYNOS5422_ATB_KFC					(1<<13)

/* ISP POWER OPTION */
#define EXYNOS5422_LPI_MASK0				EXYNOS_PMUREG(0x0004)
#define EXYNOS5422_LPI_MASK0_FD				(1 << 18) /* FD */
#define EXYNOS5422_LPI_MASK0_OTHERS			( \
							(1 << 11) | /* ISP */ \
							(1 << 12) | /* DRC */ \
							(1 << 13) | /* SCC */ \
							(1 << 14) | /* ODC */ \
...
#define EXYNOS5422_LPI_BUS_MASK0_ISP0			(1 << 13)
#define EXYNOS5422_LPI_BUS_MASK0_ISP1			(1 << 14)
#define EXYNOS5422_LPI_BUS_MASK0_RSTOP_ISP		(1 << 15)
#define EXYNOS5422_LPI_BUS_MASK0_PRSTOP_ISP		(1 << 16)

#define EXYNOS5422_ISP_ARM_OPTION			EXYNOS_PMUREG(0x2488)

/* Only for EXYNOS5422 */
#define EXYNOS5422_SYS_WDTRESET				(1 << 0)
