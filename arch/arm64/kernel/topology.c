...
void __init arch_get_hmp_domains(struct list_head *hmp_domains_list)
{
	...
	/* exclude not-incoming cpu from hmp_cpu_mask */
	cpumask_and(&hmp_fast_cpu_mask, &hmp_fast_cpu_mask, cpu_online_mask);
	cpumask_and(&hmp_slow_cpu_mask, &hmp_slow_cpu_mask, cpu_online_mask);
