...
static struct exynos_devfreq_platdata exynos5422_qos_disp = {
	.default_qos		= 167000,
};
...
void exynos5_update_district_disp_level(unsigned int idx)
{
	...
	if (idx != LV3)
		...
		pm_qos_update_request(&exynos5_disp_qos, exynos5422_qos_disp.default_qos);
}
...
static int __init exynos5_devfreq_disp_init(void)
{
	...
	exynos5_devfreq_disp_device.dev.platform_data = &exynos5422_qos_disp;
