...
#define DEVFREQ_INT_REBOOT_FREQ	(415000)

static struct exynos_devfreq_data *int_data;

static int exynos7570_devfreq_int_cmu_dump(struct device *dev,
...
static int exynos7570_devfreq_int_reboot(struct device *dev,
					struct exynos_devfreq_data *data)
{
...
static int exynos7570_devfreq_int_get_volt_table(struct device *dev, u32 *volt_table,
						struct exynos_devfreq_data *data)
{
