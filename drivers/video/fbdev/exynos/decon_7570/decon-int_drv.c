...
void decon_int_set_clocks(struct decon_device *decon)
{
	...
	if (IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_S6E36W1X01) || IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_S6E3AA2) || IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_RM69080) || IS_ENABLED(CONFIG_EXYNOS_DECON_LCD_AUO_H120BLN017)) {
