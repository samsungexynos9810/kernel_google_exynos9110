...
#define PROBE_WAKEUP_ENABLE	0	/* wake up before TSC probe */
#define PROBE_FAIL_CHECK	0	/* if TSC probe failed, unload device driver */

/* For E7270_Pro Board. */
#define CONFIG_MACH_SMDK7270	1
...
#define TSC_FW_ARRAY_NAME		S242_YF8015_1P39_GFF_FW_R01_160809
#include "S242_YF8015_1P39_GFF_FW_R01_160809.h"
...
#else
#if defined(CONFIG_MACH_SMDK7270)
// For E7270_Pro Board.
...
static s32 touch_check_functionality(struct touch_pdata *pdata)
{
	...
	pdata->irq_mode = IRQ_MODE_NORMAL;	// IRQ_MODE_THREAD, IRQ_MODE_NORMAL
...
#if !defined(CONFIG_MACH_SMDK7270)
	printk("%s - 3-1 ldo_en_gpio = 0x%02x\n", __func__, pdata->ldo_en_gpio);
