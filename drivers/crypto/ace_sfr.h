...
#elif defined(CONFIG_ACE_USE_SLIMSSS_VER_1)
#define ACE_SFR_BASE		(0x10900000)
#else
...
#define ACE_AES_KEY14		(ACE_AES_OFFSET + 0x6C)
#define ACE_AES_KEY15		(ACE_AES_OFFSET + 0x70)
#define ACE_AES_KEY16		(ACE_AES_OFFSET + 0x74)
#define ACE_AES_KEY17		(ACE_AES_OFFSET + 0x78)
#define ACE_AES_KEY18		(ACE_AES_OFFSET + 0x7C)
#endif
...
#define ACE_HASH_PRNG1		(ACE_HASH_OFFSET + 0x210)
