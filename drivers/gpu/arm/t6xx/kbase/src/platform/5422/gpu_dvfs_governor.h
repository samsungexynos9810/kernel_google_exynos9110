/* drivers/gpu/t6xx/kbase/src/platform/5422/gpu_dvfs_governor.h
 *
...
#define G3D_MAX_GOVERNOR_NUM	3

#define G3D_DVFS_GOVERNOR_DEFAULT				0
#define G3D_DVFS_GOVERNOR_STATIC				1
#define G3D_DVFS_GOVERNOR_BOOSTER				2
