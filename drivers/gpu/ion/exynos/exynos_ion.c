		...
		exynos_ion_contig_region[EXYNOS_ION_CONTIG_ID_NUM] __initconst =
{
    ...
    (CONFIG_ION_EXYNOS_SIZE_COMMON > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_COMMON),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_MFC_SH > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_MFC_SH),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_MSGBOX_SH > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_MSGBOX_SH),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_FIMD_VIDEO> 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_FIMD_VIDEO),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_GSC> 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_GSC),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_MFC_OUTPUT > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_MFC_OUTPUT),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_MFC_INPUT > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_MFC_INPUT),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_MFC_FW > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_MFC_FW),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_SECTBL > 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_SECTBL),
	},
#endif
    ...
    (CONFIG_ION_EXYNOS_SIZE_G2D_WFD> 0)
	{
		...
		.size = PAGE_ALIGN(CONFIG_ION_EXYNOS_SIZE_G2D_WFD),
	},
#endif
};
