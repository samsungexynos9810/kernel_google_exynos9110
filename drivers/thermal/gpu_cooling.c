			    ...
			    u32 *power)
{
	...
	if (!gpufreq_device->plat_get_static_power || freq == 0) {
		*power = 0;
		return 0;
	}
	...
	return gpufreq_device->plat_get_static_power(NULL, tz->passive_delay,
						     voltage, power);
}
			   ...
			   get_static_t plat_static_func)
{
	...
	if (capacitance) {
		...
		gpufreq_dev->plat_get_static_power = plat_static_func;
