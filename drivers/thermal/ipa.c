...
static void arbiter_calc(int currT)
{
	...
	trace_data.a15_freq_in = arbiter_data.cl_stats[CA15].freq;
	...
	trace_data.a7_freq_in = arbiter_data.cl_stats[CA7].freq;
	...
	trace_data.a15_2_freq_in = arbiter_data.cpu_freqs[CA15][2];
	trace_data.a15_3_freq_in = arbiter_data.cpu_freqs[CA15][3];
	trace_data.a7_0_freq_in = arbiter_data.cpu_freqs[CA7][0];
	trace_data.a7_1_freq_in = arbiter_data.cpu_freqs[CA7][1];
	trace_data.a7_2_freq_in = arbiter_data.cpu_freqs[CA7][2];
	trace_data.a7_3_freq_in = arbiter_data.cpu_freqs[CA7][3];
