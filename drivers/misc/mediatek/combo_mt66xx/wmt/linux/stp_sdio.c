...
UINT32 gStpSdioDbgLvl = STPSDIO_LOG_ERR;		// CYM
...
static struct file_operations stp_sdio_rxdbg_ops = {
    .owner  = THIS_MODULE,
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)
    gStpSdioRxDbgEntry = proc_create(STP_SDIO_RXDBG_PROCNAME, 0666, NULL, &stp_sdio_rxdbg_ops); 
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)
static struct file_operations stp_sdio_txdbg_ops = {
    .owner  = THIS_MODULE,
...
{
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)
    gStpSdioTxDbgEntry = proc_create(STP_SDIO_TXDBG_PROCNAME, 0666, NULL, &stp_sdio_txdbg_ops); 
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)
static struct file_operations stp_sdio_owndbg_ops = {
    .owner  = THIS_MODULE,
...
{
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0)
    gStpSdioOwnEntry = proc_create(STP_SDIO_OWNDBG_PROCNAME, 0666, NULL, &stp_sdio_owndbg_ops); 
