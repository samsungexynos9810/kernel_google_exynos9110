...
//0 means no need WMT.cfg
#define CFG_HAS_WMT_CFG (0)
/*******************************************************************************
*                         D A T A   T Y P E S
********************************************************************************
*/
...
INT32  wmt_conf_set_cfg_file(const CHAR *name)
{
	...
	WMT_INFO_FUNC("WMT config file is set to (%s)\n", &(gDevWmt.cWmtcfgName[0]));
...
*/
    ...
    gDevWmt.rWmtGenConf.coex_wmt_ant_mode = 3;
    gDevWmt.rWmtGenConf.coex_wmt_wifi_time_ctl = 0;
    gDevWmt.rWmtGenConf.coex_wmt_ext_pta_dev_on = 0;

    gDevWmt.rWmtGenConf.coex_bt_rssi_upper_limit = 0xD2;
    gDevWmt.rWmtGenConf.coex_bt_rssi_mid_limit   = 0xC8;
    gDevWmt.rWmtGenConf.coex_bt_rssi_lower_limit = 0xBA;
    gDevWmt.rWmtGenConf.coex_bt_pwr_high = 0x5;
    gDevWmt.rWmtGenConf.coex_bt_pwr_mid  = 0x5;
    gDevWmt.rWmtGenConf.coex_bt_pwr_low  = 0x5;

    gDevWmt.rWmtGenConf.coex_wifi_rssi_upper_limit = 0xD2;
    gDevWmt.rWmtGenConf.coex_wifi_rssi_mid_limit   = 0xC8;
    gDevWmt.rWmtGenConf.coex_wifi_rssi_lower_limit = 0xBF;
    gDevWmt.rWmtGenConf.coex_wifi_pwr_high = 0xA;
    gDevWmt.rWmtGenConf.coex_wifi_pwr_mid  = 0xA;
    gDevWmt.rWmtGenConf.coex_wifi_pwr_low  = 0xA;

    gDevWmt.rWmtGenConf.coex_ext_pta_hi_tx_tag = 6;
    gDevWmt.rWmtGenConf.coex_ext_pta_hi_rx_tag = 6;
    gDevWmt.rWmtGenConf.coex_ext_pta_lo_tx_tag = 12;
    gDevWmt.rWmtGenConf.coex_ext_pta_lo_rx_tag = 12;
    gDevWmt.rWmtGenConf.coex_ext_pta_sample_t1 = 10;
    gDevWmt.rWmtGenConf.coex_ext_pta_sample_t2 = 4;
    gDevWmt.rWmtGenConf.coex_ext_pta_wifi_bt_con_trx = 0x0;

    gDevWmt.rWmtGenConf.coex_misc_ext_pta_on = 0;
    gDevWmt.rWmtGenConf.coex_misc_ext_feature_set = 0xFFFFFFFF;

    /*GPS LNA setting*/
    gDevWmt.rWmtGenConf.wmt_gps_lna_pin = 0;
    gDevWmt.rWmtGenConf.wmt_gps_lna_enable = 1;
    
    /*Power on sequence*/
    gDevWmt.rWmtGenConf.pwr_on_rtc_slot = 0;
    gDevWmt.rWmtGenConf.pwr_on_ldo_slot = 0;
    gDevWmt.rWmtGenConf.pwr_on_rst_slot = 0;
    gDevWmt.rWmtGenConf.pwr_on_off_slot = 0;
    gDevWmt.rWmtGenConf.pwr_on_on_slot  = 0;
    gDevWmt.rWmtGenConf.co_clock_flag = 0;

    /* Combo chip side SDIO driving setting */
    gDevWmt.rWmtGenConf.sdio_driving_cfg = 0;
    
    WMT_INFO_FUNC("WMT config no need WMT.cfg\n");
#endif
}
