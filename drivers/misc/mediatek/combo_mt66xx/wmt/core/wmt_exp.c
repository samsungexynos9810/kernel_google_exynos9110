...
////////////////////////////////////////////////////////////////////////
extern int exynos_bt_op_f;
extern void exynos_check_bt_op(int bt_op);
...
extern INT32 hif_sdio_is_chipid_valid (INT32 chipId);
INT32 mtk_wcn_wmt_chipid_query (VOID)
{
	...
	UINT32 counter = 0;
	UINT32 comboChipId;
	comboChipId= mtk_wcn_hif_sdio_query_chipid(0);

	if (0 <= hif_sdio_is_chipid_valid(comboChipId))
		return comboChipId;
