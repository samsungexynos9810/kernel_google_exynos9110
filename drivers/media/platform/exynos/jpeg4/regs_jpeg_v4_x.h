 ...
 *
 * Register definition file for Samsung JPEG v.4 Encoder/Decoder
 *
...
#define S5P_JPEG_DECODE_XY_SIZE_REG	0x54	/* reserved */
#define S5P_JPEG_DECODE_IMG_FMT_REG	0x58	/* reserved */
#define S5P_JPEG_DEC_WINDOW_MARN_1	0x5c
#define S5P_JPEG_DEC_WINDOW_MARN_2	0x60
#define S5P_JPEG_IP_VERSION_NUMBER	0x64
...
#define S5P_JPEG_HOR_SCALING_SHIFT		20		/* reserved */
...
#define S5P_JPEG_VER_SCALING_SHIFT		22		/* reserved */
...
#define S5P_JPEG_DEC_WINDOW_CNTL		(1 << 24)
#define S5P_JPEG_DEC_IMG_RESLN_TYPE_SHIFT	25
#define S5P_JPEG_DEC_IMG_RESLN_TYPE_MASK	(3 << S5P_JPEG_DEC_IMG_RESLN_TYPE_SHIFT)
#define S5P_JPEG_DEC_IMG_RESLN_TYPE(x)		((x) << S5P_JPEG_DEC_IMG_RESLN_TYPE_SHIFT)
...
#define S5P_JPEG_ENC_IN_FMT_MASK	0xfffc0000
...
#define S5P_JPEG_ENC_YUV_420_IMG	(4 << 0)
#define S5P_JPEG_ENC_YUV_422V_IMG	(5 << 0)
#define S5P_JPEG_ENC_YUV_411_IMG	(6 << 0)
...
#define S5P_JPEG_DEC_YUV_422V_IMG	(5 << 0)
#define S5P_JPEG_DEC_YUV_411_IMG	(6 << 0)
...
#define S5P_JPEG_RGB_IP_RGB_24BIT_IMG		(6 << S5P_JPEG_RGB_IP_SHIFT)
...
#define S5P_JPEG_YUV_422V_IP_SHIFT		18
#define S5P_JPEG_YUV_422V_IP_MASK		(7 << S5P_JPEG_YUV_422V_IP_SHIFT)
#define S5P_JPEG_YUV_422V_IP_YUV_422V_2P_IMG	(4 << S5P_JPEG_YUV_422V_IP_SHIFT)
#define S5P_JPEG_YUV_422V_IP_YUV_422V_3P_IMG	(5 << S5P_JPEG_YUV_422V_IP_SHIFT)

#define S5P_JPEG_YUV_411_IP_SHIFT		21
#define S5P_JPEG_YUV_411_IP_MASK		(7 << S5P_JPEG_YUV_411_IP_SHIFT)
#define S5P_JPEG_YUV_411_IP_YUV_411_2P_IMG	(4 << S5P_JPEG_YUV_411_IP_SHIFT)
#define S5P_JPEG_YUV_411_IP_YUV_411_3P_IMG	(5 << S5P_JPEG_YUV_411_IP_SHIFT)

#define S5P_JPEG_FMT_SHIFT		24
#define S5P_JPEG_FMT_MASK		(7 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_GRAY		(0 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_YUV_444	(1 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_YUV_422	(2 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_YUV_420	(3 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_YUV_422V	(4 << S5P_JPEG_FMT_SHIFT)
#define S5P_JPEG_FMT_YUV_411	(5 << S5P_JPEG_FMT_SHIFT)

#define S5P_JPEG_SWAP_CHROMA_CrCb	(0 << 27)
#define S5P_JPEG_SWAP_CHROMA_CbCr	(1 << 27)

#define S5P_JPEG_RE_ORDER_YUV_422_1P_SHIFT	28
...
#define S5P_JPEG_SWAP_RGB_SHIFT		30
...
/* JPEG PADDING */
#define S5P_JPEG_PAD_Y_R_SHIFT		0
#define S5P_JPEG_PAD_Y_R_MASK		(0xff << S5P_JPEG_PAD_Y_R_SHIFT)
#define S5P_JPEG_PAD_Y_R(x)		(((x) & 0xff) << S5P_JPEG_PAD_Y_R_SHIFT)
#define S5P_JPEG_PAD_CB_G_SHIFT		8
#define S5P_JPEG_PAD_CB_G_MASK		(0xff << S5P_JPEG_PAD_CB_G_SHIFT)
#define S5P_JPEG_PAD_CB_G(x)		(((x) & 0xff) << S5P_JPEG_PAD_CB_G_SHIFT)
#define S5P_JPEG_PAD_CR_B_SHIFT		16
#define S5P_JPEG_PAD_CR_B_MASK		(0xff << S5P_JPEG_PAD_CR_B_SHIFT)
#define S5P_JPEG_PAD_CR_B(x)		(((X) & 0xff) << S5P_JPEG_PAD_CR_B_SHIFT)
#define S5P_JPEG_ARGB32_SHIFT		24
#define S5P_JPEG_ARGB32_MASK		(0xff << S5P_JPEG_ARGB32_SHIFT)
#define S5P_JPEG_ARGB32(x)		(((x) & 0xff) << S5P_JPEG_ARGB32_SHIFT)

/* JPEG Decode Window mode */
#define S5P_JPEG_IMG_TOP_MARGIN_SHIFT		0
#define S5P_JPEG_IMG_TOP_MARGIN_MASK		(0xffff << S5P_JPEG_IMG_TOP_MARGIN_SHIFT)
#define S5P_JPEG_IMG_TOP_MARGIN(x)		(((x) & S5P_JPEG_IMG_TOP_MARGIN_MASK) << S5P_JPEG_IMG_TOP_MARGIN_SHIFT)
#define S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT	16
#define S5P_JPEG_IMG_BOTTOM_MARGIN_MASK		(0xffff << S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT)
#define S5P_JPEG_IMG_BOTTOM_MARGIN(x)		(((x) & S5P_JPEG_IMG_BOTTOM_MARGIN_MASK) << S5P_JPEG_IMG_BOTTOM_MARGIN_SHIFT)

#define S5P_JPEG_IMG_LEFT_MARGIN_SHIFT		0
#define S5P_JPEG_IMG_LEFT_MARGIN_MASK		(0xffff << S5P_JPEG_IMG_LEFT_MARGIN_SHIFT)
#define S5P_JPEG_IMG_LEFT_MARGIN(x)		(((x) & S5P_JPEG_IMG_LEFT_MARGIN_MASK) << S5P_JPEG_IMG_LEFT_MARGIN_SHIFT)
#define S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT		16
#define S5P_JPEG_IMG_RIGHT_MARGIN_MASK		(0xffff << S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT)
#define S5P_JPEG_IMG_RIGHT_MARGIN(x)		(((x) & S5P_JPEG_IMG_RIGHT_MARGIN_MASK) << S5P_JPEG_IMG_RIGHT_MARGIN_SHIFT)

/* JPEG IP Version */
#define S5P_JPEG_IP_VERSION_SHIFT		0
#define S5P_JPEG_IP_VERSION_MASK		(0xffffffff << S5P_JPEG_IP_VERSION_SHIFT)
#define S5P_JPEG_IP_VERSION(x)			(((x) & S5P_JPEG_IP_VERSION_MASK) << S5P_JPEG_IP_VERSION_SHIFT)
...
#define S5P_JPEG_NUMBER_OF_COMPONENTS_SHIFT	16
#define S5P_JPEG_NUMBER_OF_COMPONENTS_MASK	(0xff << S5P_JPEG_NUMBER_OF_COMPONENTS_SHIFT)
#define S5P_JPEG_NUMBER_OF_COMPONENTS(x)	(((x) & 0xff) << S5P_JPEG_NUMBER_OF_COMPONENTS_SHIFT)
