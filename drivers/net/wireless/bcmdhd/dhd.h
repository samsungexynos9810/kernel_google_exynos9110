 ...
 *
 * $Id: dhd.h 664898 2017-05-04 12:25:54Z $
 */
...
#include <asm/unaligned.h>
	...
	|| defined(CONFIG_WAKELOCK))
#include <linux/wakelock.h>
#endif /* (LINUX_VERSION_CODE >= (2, 6, 27)) && ((CONFIG_HAS_WAKELOCK) || (CONFIG_WAKELOCK)) */
...
#define APF_PROGRAM_MAX_SIZE	(2 * 1024)
...
extern bool dhd_prot_is_ring_empty(dhd_pub_t *dhd, void *prot_info);
