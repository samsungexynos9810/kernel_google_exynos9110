 ...
 *
 * $Id: bcmsdh_linux.c 664392 2017-03-24 10:42:39Z $
 */
...
#if !defined(CONFIG_HAS_WAKELOCK) && !defined(CONFIG_WAKELOCK) && (LINUX_VERSION_CODE > \
	KERNEL_VERSION(2, 6, 36))
	if (dev && device_init_wakeup(dev, true) == 0)
		bcmsdh_osinfo->dev_wake_enabled = TRUE;
#endif /* !(CONFIG_HAS_WAKELOCK) && !(CONFIG_WAKELOCK) && LINUX_VERSION_CODE > (2, 6, 36)) */
...
#endif
/* !(CONFIG_HAS_WAKELOCK) && !(CONFIG_WAKELOCK) && LINUX_VERSION_CODE > (2, 6, 36)) */
