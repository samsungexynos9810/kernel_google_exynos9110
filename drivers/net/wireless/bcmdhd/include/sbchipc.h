 ...
 *
 * $Id: sbchipc.h 662974 2016-11-24 09:12:30Z $
 *
...
/* 4373 related */
#define CST4373_JTAG_ENABLE(cs)		(((cs) & (1 << 0)) != 0) /* CHIPSTATUS JTAG ENABLE */
#define CST4373_CHIPMODE_RSRC_INIT0(cs) (((cs) & (1 << 1)) != 0) /* CHIPSTATUS RSRC INIT0 */
#define CST4373_SFLASH_PRESENT(cs)      (((cs) & (1 << 4)) != 0) /* CHIPSTATUS SFLASH PRESENT */
#define CST4373_SDIO_PADVDDIO(cs)       (((cs) & (1 << 5)) != 0) /* CHIPSTATUS SDIO PAD VDDIO */
#define CST4373_CHIPMODE_PCIE(cs)       (((cs) & (1 << 6)) != 0) /* CHIPSTATUS PCIE MODE */
#define CST4373_CHIPMODE_SDIOD(cs)      (((cs) & (1 << 7)) != 0) /* CHIPSTATUS SDIO MODE */
#define CST4373_CHIPMODE_USB20D(cs)     (((cs) & (1 << 8)) != 0) /* CHIPSTATUS USB MODE */
#define CST4373_USBHUB_BYPASS(cs)       (((cs) & (1 << 9)) != 0) /* CHIPSTATUS USB HUBBYPASS */
#define STRAP4373_CHIPMODE_RSRC_INIT1           0x1              /* RSRC INIT1 */
#define STRAP4373_VTRIM_EN                      0x1              /* VTRIM */
#define STRAP4373_SFLASH_PRESENT                0x1              /* SFLASH_PRESENT */
#define OTP4373_SFLASH_BYTE_OFFSET              680              /* byte offset for bit 5440 */
#define OTP4373_SFLASH_MASK                     0x3F             /* 6 OTP bits, 5445:5440 */
#define OTP4373_SFLASH_PRESENT_MASK             0x1              /* OTP bit 5440 */
#define OTP4373_SFLASH_TYPE_MASK                0x2              /* OTP bit 5441 */
#define OTP4373_SFLASH_TYPE_SHIFT               0x1              /* OTP bit 5441 */
#define OTP4373_SFLASH_CLKDIV_MASK              0x3C             /* OTP bit 5445:5442 */
#define OTP4373_SFLASH_CLKDIV_SHIFT             0x2              /* OTP bit 5445:5442 */
#define SPROM4373_OTP_SELECT                    0x00000010       /* CC SpromCtrl bit 4 */
#define SPROM4373_OTP_PRESENT                   0x00000020       /* CC SpromCtrl bit 5 */
#define CC4373_SFLASH_CLKDIV_MASK               0x1F000000       /* ClkDiv bits 28:24 */
#define CC4373_SFLASH_CLKDIV_SHIFT 25 /* Clkdiv bit 24 is always cleared, ensuring an even number */
