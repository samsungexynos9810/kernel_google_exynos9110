 ...
 *
 * $Id: wl_cfg80211.c 489825 2014-07-08 09:03:49Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
...
static s32 wl_cfg80211_tdls_mgmt(struct wiphy *wiphy, struct net_device *dev,
	u8 *peer, u8 action_code, u8 dialog_token, u16 status_code, u32 peer_capability,
	const u8 *data, size_t len);
#elif ((LINUX_VERSION_CODE >= KERNEL_VERSION(3, 16, 0)) && (LINUX_VERSION_CODE < KERNEL_VERSION(3, 18, 0)))
static s32 wl_cfg80211_tdls_mgmt(struct wiphy *wiphy, struct net_device *dev,
	...
	void *ptr)
{
	...
	// Originally. '!cfg' has not checked on kernel_version > 3.10. It caused NULL.
	// I can't understand why original code skips this check...
