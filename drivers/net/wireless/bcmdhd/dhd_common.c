 ...
 *
 * $Id: dhd_common.c 666347 2017-08-14 05:54:39Z $
 */
#include <typedefs.h>
#include <osl.h>
...
#else
/* By default enabled DHD_ERROR_VAL */
...
#endif /* (OEM_ANDROID && WL_WIRELESS_EXT) || (PNO_SUPPORT && !WL_SCHED_SCAN) */
...
dhd_get_clminfo(dhd_pub_t *dhd, char *clm_path)
{
	...
	if ((len > 0) && (len < MAX_CLMINFO_BUF_SIZE) && memblock) {
		...
		strcpy(clm_path, CONFIG_BCMDHD_CLM_PATH);
