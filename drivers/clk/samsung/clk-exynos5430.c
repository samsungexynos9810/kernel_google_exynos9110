...
struct samsung_div_clock exynos5430_div_clks[] __initdata = {
	...
	CDIV(dout_pclk_dbg_egl, "dout_atclk", EXYNOS5430_DIV_EGL0, 20, 3),
	CDIV(dout_pclk_egl, "dout_atclk", EXYNOS5430_DIV_EGL0, 12, 3),
	...
	CDIV(dout_sclk_spi0_b, "mout_sclk_spi0", EXYNOS5430_DIV_TOP_PERIC0, 4, 8),
	CDIV(dout_sclk_spi1_b, "mout_sclk_spi1", EXYNOS5430_DIV_TOP_PERIC0, 16, 8),
	CDIV(dout_sclk_spi2_b, "mout_sclk_spi2", EXYNOS5430_DIV_TOP_PERIC1, 4, 8),
	...
	CDIV(dout_sclk_pixelasync_lite_c, "mout_sclk_pixelasync_lite_c_b", EXYNOS5430_DIV_CAM03, 10, 3),
	...
	CDIV(dout_aclk_csis1, "mout_aclk_csis1_b", EXYNOS5430_DIV_CAM02, 16, 3),
	...
	CDIV(dout_aclk_lite_c, "mout_aclk_lite_c_b", EXYNOS5430_DIV_CAM11, 0, 2),
	CDIV(dout_aclk_fd, "mout_aclk_fd_b", EXYNOS5430_DIV_CAM11, 8, 2),
	CDIV(dout_aclk_csis2_a, "mout_aclk_csis2_b", EXYNOS5430_DIV_CAM11, 16, 2),
...
struct samsung_gate_clock exynos5430_gate_clks[] __initdata = {
	...
	CGTE(aclk_cam0_400, "aclk_cam0_400", "dout_aclk_cam0_400_top", EXYNOS5430_ENABLE_ACLK_TOP, 9, CLK_SET_RATE_PARENT, 0),
