...
struct samsung_gate_clock exynos5430_gate_clks[] __initdata = {
	...
	/* DISP1 */
	CGTE(gate_ppmu_tv1x, "gate_ppmu_tv1x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 30, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_ppmu_tv0x, "gate_ppmu_tv0x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 29, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_ppmu_decon1x, "gate_ppmu_decon1x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 28, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_ppmu_decon0x, "gate_ppmu_decon0x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 27, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_smmu_tv1x, "gate_smmu_tv1x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 26, CLK_IGNORE_UNUSED, 0),
