...
enum exynos5430_clks {
	...
	mphy_pll, disp_pll, isp_pll, aud_pll, fout_g3d_pll,
...
PNAME(mout_sclk_decon_tv_eclk_p) = { "mout_disp_pll", "mout_sclk_tv_decon_eclk_user" };
...
struct samsung_mux_clock exynos5430_mux_clks[] __initdata = {
	...
	CMUX(mout_bus_pll_egl_user, EXYNOS5430_SRC_SEL_EGL1, 0, 1),
	CMUX(mout_egl, EXYNOS5430_SRC_SEL_EGL2, 0, 1),

	/* KFC */
	CMUX(mout_kfc_pll, EXYNOS5430_SRC_SEL_KFC0, 0, 1),
	CMUX(mout_bus_pll_kfc_user, EXYNOS5430_SRC_SEL_KFC1, 0, 1),
	...
	CMUX(mout_aclk_hevc_400, EXYNOS5430_SRC_SEL_TOP2, 28, 1),
	...
	CMUX(mout_aclk_mfc0_333_a, EXYNOS5430_SRC_SEL_TOP4, 0, 1),
	CMUX(mout_aclk_mfc0_333_b, EXYNOS5430_SRC_SEL_TOP4, 4, 1),
	CMUX(mout_aclk_mfc0_333_c, EXYNOS5430_SRC_SEL_TOP4, 8, 1),
	CMUX(mout_aclk_mfc1_333_a, EXYNOS5430_SRC_SEL_TOP4, 16, 1),
	CMUX(mout_aclk_mfc1_333_b, EXYNOS5430_SRC_SEL_TOP4, 20, 1),
	...
	/* MIF */
	CMUX(mout_mem0_pll, EXYNOS5430_SRC_SEL_MIF0, 0, 1),
	CMUX(mout_mem1_pll, EXYNOS5430_SRC_SEL_MIF0, 4, 1),
	CMUX(mout_mfc_pll, EXYNOS5430_SRC_SEL_MIF0, 12, 1),
	CMUX(mout_bus_pll, EXYNOS5430_SRC_SEL_MIF0, 8, 1),
	CMUX(mout_mem0_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 16, 1),
	CMUX(mout_mem1_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 20, 1),
	CMUX(mout_mfc_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 218, 1),
	CMUX(mout_bus_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 24, 1),
	...
	CMUX(mout_aclk_mif_400, EXYNOS5430_SRC_SEL_MIF2, 0, 1),
	CMUX(mout_aclk_mifnm_200, EXYNOS5430_SRC_SEL_MIF2, 8, 1),
	...
	CMUX(mout_sclk_decon_tv_eclk_a, EXYNOS5430_SRC_SEL_MIF5, 16, 1),
	CMUX(mout_sclk_decon_tv_eclk_b, EXYNOS5430_SRC_SEL_MIF5, 20, 1),
	CMUX(mout_sclk_decon_tv_eclk_c, EXYNOS5430_SRC_SEL_MIF5, 24, 1),
	...
	CMUX(mout_sclk_dsim0_a, EXYNOS5430_SRC_SEL_MIF6, 0, 1),
	CMUX(mout_sclk_dsim0_b, EXYNOS5430_SRC_SEL_MIF6, 4, 1),
	CMUX(mout_sclk_dsim0_c, EXYNOS5430_SRC_SEL_MIF6, 8, 1),
	...
	CMUX(mout_aclk_mscl_400_user, EXYNOS5430_SRC_SEL_MSCL0, 0, 1),
	CMUX(mout_sclk_jpeg_user, EXYNOS5430_SRC_SEL_MSCL0, 4, 1),
	CMUX(mout_sclk_jpeg, EXYNOS5430_SRC_SEL_MSCL1, 0, 1),
	...
	CMUX(mout_sclk_decon_eclk, EXYNOS5430_SRC_SEL_DISP3, 0, 1),
	CMUX(mout_sclk_decon_vclk_user, EXYNOS5430_SRC_SEL_DISP1, 12, 1),
	CMUX(mout_sclk_decon_vclk, EXYNOS5430_SRC_SEL_DISP3, 4, 1),
	CMUX(mout_sclk_decon_tv_eclk_user, EXYNOS5430_SRC_SEL_DISP1, 16, 1),
	CMUX(mout_sclk_decon_tv_eclk, EXYNOS5430_SRC_SEL_DISP3, 8, 1),
	CMUX(mout_sclk_dsd_user, EXYNOS5430_SRC_SEL_DISP1, 20, 1),
	CMUX(mout_sclk_dsim0_user, EXYNOS5430_SRC_SEL_DISP1, 24, 1),
	CMUX(mout_sclk_dsim0, EXYNOS5430_SRC_SEL_DISP3, 12, 1),
	...
	CMUX(mout_ufs_pll_user, EXYNOS5430_SRC_SEL_FSYS0, 4, 1),
...
struct samsung_gate_clock exynos5430_gate_clks[] __initdata = {
	...
	/* sclk TOP_MSCL */
	CGTE(sclk_jpeg_mscl, "sclk_jpeg_mscl", "dout_sclk_jpeg", EXYNOS5430_ENABLE_SCLK_TOP_MSCL, 0, 0, 0),
	...
	CGTE(sclk_isp_mctadc_cam1, "sclk_isp_mctadc_cam1", "oscclk", EXYNOS5430_ENABLE_SCLK_TOP_CAM1, 0, 0, 0),
	...
	/* sclk TOP_FSYS */
	CGTE(sclk_usbdrd30_fsys, "sclk_usbdrd30_fsys", "dout_usbdrd30", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 0, 0, 0),
	CGTE(sclk_ufsunipro_fsys, "sclk_ufsunipro_fsys", "dout_sclk_ufsunipro", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 3, 0, 0),
	CGTE(sclk_mmc0_fsys, "sclk_mmc0_fsys", "dout_mmc0_b", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 4, 0, 0),
	CGTE(sclk_mmc1_fsys, "sclk_mmc1_fsys", "dout_mmc1_b", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 5, 0, 0),
	CGTE(sclk_mmc2_fsys, "sclk_mmc2_fsys", "dout_mmc2_b", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 6, 0, 0),

	/* sclk TOP_PERIC */
	CGTE(sclk_spi0_peric, "sclk_spi0_peric", "dout_sclk_spi0_b", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 0, 0, 0),
	CGTE(sclk_spi1_peric, "sclk_spi1_peric", "dout_sclk_spi1_b", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 1, 0, 0),
	CGTE(sclk_spi2_peric, "sclk_spi2_peric", "dout_sclk_spi2_b", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 2, 0, 0),
	CGTE(sclk_uart0_peric, "sclk_uart0_peric", "dout_sclk_uart0", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 3, 0, 0),
	CGTE(sclk_uart1_peric, "sclk_uart1_peric", "dout_sclk_uart1", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 4, 0, 0),
	CGTE(sclk_uart2_peric, "sclk_uart2_peric", "dout_sclk_uart2", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 5, 0, 0),
	CGTE(sclk_pcm1_peric, "sclk_pcm1_peric", "dout_sclk_pcm1", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 7, 0, 0),
	CGTE(sclk_i2s1_peric, "sclk_i2s1_peric", "dout_sclk_i2s1", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 8, 0, 0),
	CGTE(sclk_spdif_peric, "sclk_spdif_peric", "mout_sclk_spdif", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 9, 0, 0),
	CGTE(sclk_slimbus_peric, "sclk_slimbus_peric", "dout_sclk_slimbus", EXYNOS5430_ENABLE_SCLK_TOP_PERIC, 10, 0, 0),

	/* MIF */
	CGTE(sclk_mfc_pll, "sclk_mfc_pll", "mout_mfc_pll_div2", EXYNOS5430_ENABLE_SCLK_MIF, 0, 0, 0),
	CGTE(sclk_bus_pll, "sclk_bus_pll", "mout_bus_pll_div2", EXYNOS5430_ENABLE_SCLK_MIF, 0, 0, 0),
	...
	CGTE(sclk_decon_eclk_disp, "sclk_decon_eclk_disp", "dout_sclk_decon_eclk", EXYNOS5430_ENABLE_SCLK_MIF, 5, 0, 0),
	CGTE(sclk_decon_vclk_disp, "sclk_decon_vclk_disp", "dout_sclk_decon_vclk", EXYNOS5430_ENABLE_SCLK_MIF, 6, 0, 0),
	CGTE(sclk_decon_tv_eclk_disp, "sclk_decon_tv_eclk_disp", "dout_sclk_decon_tv_eclk", EXYNOS5430_ENABLE_SCLK_MIF, 7, 0, 0),
	CGTE(sclk_dsd_disp, "sclk_dsd_disp", "dout_sclk_dsd", EXYNOS5430_ENABLE_SCLK_MIF, 0, 0, 0),
	CGTE(sclk_dsim0_disp, "sclk_dism0_disp", "dout_sclk_dsim0", EXYNOS5430_ENABLE_SCLK_MIF, 0, 0, 0),
...
#endif
	CGTE(sclk_hdmi_spdif_disp, "sclk_hdmi_spdif_disp", "mout_sclk_hdmi_spdif", EXYNOS5430_ENABLE_SCLK_DISP, 4, 0, 0),
	...
	CGTE(phyclk_hdmiphy_tmds_clko, "phyclk_hdmiphy_tmds_clko", "mout_phyclk_hdmiphy_tmds_clko_user", EXYNOS5430_ENABLE_SCLK_DISP, 11, 0, 0),
	...
	/* PERIC */
	CGTE(sclk_pcm1, "sclk_pcm1", "sclk_pcm1_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 7, 0, 0),
	CGTE(sclk_i2s1, "sclk_i2s1", "sclk_i2s1_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 6, 0, 0),
	CGTE(sclk_spi0, "sclk_spi0", "sclk_spi0_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 3, 0, 0),
	CGTE(sclk_spi1, "sclk_spi1", "sclk_spi1_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 4, 0, 0),
	CGTE(sclk_spi2, "sclk_spi2", "sclk_spi2_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 5, 0, 0),
	CGTE(sclk_uart0, "sclk_uart0", "sclk_uart0_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 0, 0, 0),
	CGTE(sclk_uart1, "sclk_uart1", "sclk_uart1_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 1, 0, 0),
	CGTE(sclk_uart2, "sclk_uart2", "sclk_uart2_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 2, 0, 0),
	CGTE(sclk_slimbus, "sclk_slimbus", "sclk_slimbus_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 9, 0, 0),
	CGTE(sclk_spdif, "sclk_spdif", "sclk_spdif_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 8, 0, 0),
	...
	/* MSCL */
	CGTE(sclk_jpeg, "sclk_jpeg", "mout_sclk_jpeg", EXYNOS5430_ENABLE_SCLK_MSCL, 0, 0, 0),
	...
	CGTE(pclk_dbg_aud, "pclk_dbg_aud", "dout_pclk_dbg_aud", EXYNOS5430_ENABLE_SCLK_AUD0, 1, 0, 0),
	CGTE(sclk_aud_i2s, "sclk_aud_i2s", "dout_sclk_aud_i2s", EXYNOS5430_SRC_ENABLE_AUD1, 0, 0, 0),
	...
	CGTE(gate_mipidphy, "gate_mipidphy", NULL, EXYNOS5430_ENABLE_IP_DISP0, 5, 0, 0),
	...
	CGTE(gate_smmu_decon1x, "gate_smmu_decon1x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 24, 0, 0),
	CGTE(gate_smmu_decon0x, "gate_smmu_decon0x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 23, 0, 0),
	CGTE(gate_bts_decontv_m3, "gate_bts_decontv_m3", NULL, EXYNOS5430_ENABLE_IP_DISP1, 22, 0, 0),
	CGTE(gate_bts_decontv_m2, "gate_bts_decontv_m2", NULL, EXYNOS5430_ENABLE_IP_DISP1, 21, 0, 0),
	CGTE(gate_bts_decontv_m1, "gate_bts_decontv_m1", NULL, EXYNOS5430_ENABLE_IP_DISP1, 20, 0, 0),
	CGTE(gate_bts_decontv_m0, "gate_bts_decontv_m0", NULL, EXYNOS5430_ENABLE_IP_DISP1, 19, 0, 0),
	CGTE(gate_bts_deconm4, "gate_bts_deconm4", NULL, EXYNOS5430_ENABLE_IP_DISP1, 18, 0, 0),
	CGTE(gate_bts_deconm3, "gate_bts_deconm3", NULL, EXYNOS5430_ENABLE_IP_DISP1, 17, 0, 0),
	CGTE(gate_bts_deconm2, "gate_bts_deconm2", NULL, EXYNOS5430_ENABLE_IP_DISP1, 16, 0, 0),
	CGTE(gate_bts_deconm1, "gate_bts_deconm1", NULL, EXYNOS5430_ENABLE_IP_DISP1, 15, 0, 0),
	CGTE(gate_bts_deconm0, "gate_bts_deconm0", NULL, EXYNOS5430_ENABLE_IP_DISP1, 14, 0, 0),
	CGTE(gate_ahb2apb_dispsfr2p, "gate_ahb2apb_dispsfr2p", NULL, EXYNOS5430_ENABLE_IP_DISP1, 13, 0, 0),
	CGTE(gate_ahb2apb_dispsfr1p, "gate_ahb2apb_dispsfr1p", NULL, EXYNOS5430_ENABLE_IP_DISP1, 12, 0, 0),
	CGTE(gate_ahb2apb_dispsfr0p, "gate_ahb2apb_dispsfr0p", NULL, EXYNOS5430_ENABLE_IP_DISP1, 11, 0, 0),
	CGTE(gate_ahb_disph, "gate_ahb_disph", NULL, EXYNOS5430_ENABLE_IP_DISP1, 8, 0, 0),
	CGTE(gate_xiu_tv1x, "gate_xiu_tv1x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 7, 0, 0),
	CGTE(gate_xiu_tv0x, "gate_xiu_tv0x", NULL, EXYNOS5430_ENABLE_IP_DISP1, 6, 0, 0),
	...
	/* CAM0 */
	CGTE(gate_pmu_cam0, "gate_pmu_cam0", NULL, EXYNOS5430_ENABLE_IP_CAM00, 9, 0, 0),
	CGTE(gate_sysreg_cam0, "gate_sysreg_cam0", NULL, EXYNOS5430_ENABLE_IP_CAM00, 8, 0, 0),
	CGTE(gate_cmu_cam0_local, "gate_cmu_cam0_local", NULL, EXYNOS5430_ENABLE_IP_CAM00, 7, 0, 0),
	CGTE(gate_csis1, "gate_csis1", NULL, EXYNOS5430_ENABLE_IP_CAM00, 6, 0, 0),
	CGTE(gate_csis0, "gate_csis0", NULL, EXYNOS5430_ENABLE_IP_CAM00, 5, 0, 0),
	CGTE(gate_3aa1, "gate_3aa1", NULL, EXYNOS5430_ENABLE_IP_CAM00, 4, 0, 0),
	CGTE(gate_3aa0, "gate_3aa0", NULL, EXYNOS5430_ENABLE_IP_CAM00, 3, 0, 0),
	CGTE(gate_lite_d, "gate_lite_d", NULL, EXYNOS5430_ENABLE_IP_CAM00, 2, 0, 0),
	CGTE(gate_lite_b, "gate_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM00, 1, 0, 0),
	CGTE(gate_lite_a, "gate_lite_a", NULL, EXYNOS5430_ENABLE_IP_CAM00, 0, 0, 0),

	CGTE(gate_ahbsyncdn, "gate_ahbsyncdn", NULL, EXYNOS5430_ENABLE_IP_CAM01, 22, 0, 0),
	CGTE(gate_axius_lite_d, "gate_axius_lite_d", NULL, EXYNOS5430_ENABLE_IP_CAM01, 21, 0, 0),
	CGTE(gate_axius_lite_b, "gate_axius_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM01, 20, 0, 0),
	CGTE(gate_axius_lite_a, "gate_axius_lite_a", NULL, EXYNOS5430_ENABLE_IP_CAM01, 19, 0, 0),
	CGTE(gate_asyncapb_3aa1, "gate_asyncapb_3aa1", NULL, EXYNOS5430_ENABLE_IP_CAM01, 18, 0, 0),
	CGTE(gate_asyncapb_3aa0, "gate_asyncapb_3aa0", NULL, EXYNOS5430_ENABLE_IP_CAM01, 17, 0, 0),
	CGTE(gate_asyncapb_lite_d, "gate_asyncapb_lite_d", NULL, EXYNOS5430_ENABLE_IP_CAM01, 16, 0, 0),
	CGTE(gate_asyncapb_lite_b, "gate_asyncapb_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM01, 15, 0, 0),
	CGTE(gate_asyncapb_lite_a, "gate_asyncapb_lite_a", NULL, EXYNOS5430_ENABLE_IP_CAM01, 14, 0, 0),
	CGTE(gate_asyncaxi_cam1, "gate_asyncaxi_cam1", NULL, EXYNOS5430_ENABLE_IP_CAM01, 13, 0, 0),
	CGTE(gate_asyncaxi_isp0p, "gate_asyncaxi_isp0p", NULL, EXYNOS5430_ENABLE_IP_CAM01, 12, 0, 0),
	CGTE(gate_asyncaxi_3aa1, "gate_asyncaxi_3aa1", NULL, EXYNOS5430_ENABLE_IP_CAM01, 11, 0, 0),
	CGTE(gate_asyncaxi_3aa0, "gate_asyncaxi_3aa0", NULL, EXYNOS5430_ENABLE_IP_CAM01, 10, 0, 0),
	CGTE(gate_asyncaxi_lite_d, "gate_asyncaxi_lite_d", NULL, EXYNOS5430_ENABLE_IP_CAM01, 9, 0, 0),
	CGTE(gate_asyncaxi_lite_b, "gate_asyncaxi_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM01, 8, 0, 0),
	CGTE(gate_asyncaxi_lite_a, "gate_asyncaxi_lite_a", NULL, EXYNOS5430_ENABLE_IP_CAM01, 7, 0, 0),
	CGTE(gate_ahb2apb_ispsfrp, "gate_ahb2apb_ispsfrp", NULL, EXYNOS5430_ENABLE_IP_CAM01, 6, 0, 0),
	CGTE(gate_axi2apb_isp0p, "gate_axi2apb_isp0p", NULL, EXYNOS5430_ENABLE_IP_CAM01, 5, 0, 0),
	CGTE(gate_axi2ahb_isp0p, "gate_axi2ahb_isp0p", NULL, EXYNOS5430_ENABLE_IP_CAM01, 4, 0, 0),
	CGTE(gate_xiu_is0x, "gate_xiu_is0x", NULL, EXYNOS5430_ENABLE_IP_CAM01, 3, 0, 0),
	CGTE(gate_xiu_is0ex, "gate_xiu_is0ex", NULL, EXYNOS5430_ENABLE_IP_CAM01, 2, 0, 0),
	CGTE(gate_cam0np_276, "gate_cam0np_276", NULL, EXYNOS5430_ENABLE_IP_CAM01, 1, 0, 0),
	CGTE(gate_cam0nd_400, "gate_cam0nd_400", NULL, EXYNOS5430_ENABLE_IP_CAM01, 0, 0, 0),
	...
	CGTE(gate_qe_3aa1, "gate_qe_3aa1", NULL, EXYNOS5430_ENABLE_IP_CAM02, 4, 0, 0),
	CGTE(gate_qe_3aa0, "gate_qe_3aa0", NULL, EXYNOS5430_ENABLE_IP_CAM02, 3, 0, 0),
	CGTE(gate_qe_lite_d, "gate_qe_lite_d", NULL, EXYNOS5430_ENABLE_IP_CAM02, 2, 0, 0),
	CGTE(gate_qe_lite_b, "gate_qe_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM02, 1, 0, 0),
	CGTE(gate_qe_lite_a, "gate_qe_lite_a", NULL, EXYNOS5430_ENABLE_IP_CAM02, 0, 0, 0),

	CGTE(gate_lite_freecnt, "gate_lite_freecnt", NULL, EXYNOS5430_ENABLE_IP_CAM03, 4, 0, 0),
	CGTE(gate_pixelasync_3aa1, "gate_pixelasync_3aa1", NULL, EXYNOS5430_ENABLE_IP_CAM03, 3, 0, 0),
	CGTE(gate_pixelasync_3aa0, "gate_pixelasync_3aa0", NULL, EXYNOS5430_ENABLE_IP_CAM03, 2, 0, 0),
	CGTE(gate_pixelasync_lite_c, "gate_pixelasync_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM03, 1, 0, 0),
	CGTE(gate_pixelasync_lite_c_init, "gate_pixelasync_lite_c_init", NULL, EXYNOS5430_ENABLE_IP_CAM03, 0, 0, 0),

	CGTE(gate_csis1_local, "gate_csis1_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 6, 0, 0),
	CGTE(gate_csis0_local, "gate_csis0_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 5, 0, 0),
	CGTE(gate_3aa1_local, "gate_3aa1_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 4, 0, 0),
	CGTE(gate_3aa0_local, "gate_3aa0_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 3, 0, 0),
	CGTE(gate_lite_d_local, "gate_lite_d_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 2, 0, 0),
	CGTE(gate_lite_b_local, "gate_lite_b_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 1, 0, 0),
	CGTE(gate_lite_a_local, "gate_lite_a_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL0, 0, 0, 0),

	CGTE(gate_lite_freecnt_local, "gate_lite_freecnt_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL1, 4, 0, 0),
	CGTE(gate_pixelasync_3aa1_local, "gate_pixelasync_3aa1_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL1, 3, 0, 0),
	CGTE(gate_pixelasync_3aa0_local, "gate_pixelasync_3aa0_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL1, 2, 0, 0),
	CGTE(gate_pixelasync_lite_c_local, "gate_pixelasync_lite_c_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL1, 1, 0, 0),
	CGTE(gate_pixelasync_lite_c_init_local, "gate_pixelasync_lite_c_init_local", NULL, EXYNOS5430_ENABLE_IP_CAM0_LOCAL1, 0, 0, 0),

	/* CAM1 */
	CGTE(gate_rxbyteclkhs0_s2b, "gate_rxbyteclkhs0_s2b", NULL, EXYNOS5430_ENABLE_IP_CAM10, 23, 0, 0),
	CGTE(gate_lite_c_freecnt, "gate_lite_c_freecnt", NULL, EXYNOS5430_ENABLE_IP_CAM10, 22, 0, 0),
	CGTE(gate_pixelasyncm_fd, "gate_pixelasyncm_fd", NULL, EXYNOS5430_ENABLE_IP_CAM10, 21, 0, 0),
	CGTE(gate_pixelasyncs_lite_c, "gate_pixelasyncs_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM10, 20, 0, 0),
	CGTE(gate_cssys, "gate_cssys", NULL, EXYNOS5430_ENABLE_IP_CAM10, 19, 0, 0),
	CGTE(gate_pmu_cam1, "gate_pmu_cam1", NULL, EXYNOS5430_ENABLE_IP_CAM10, 18, 0, 0),
	CGTE(gate_sysreg_cam1, "gate_sysreg_cam1", NULL, EXYNOS5430_ENABLE_IP_CAM10, 17, 0, 0),
	CGTE(gate_cmu_cam1_local, "gate_cmu_cam1_local", NULL, EXYNOS5430_ENABLE_IP_CAM10, 16, 0, 0),
	CGTE(gate_isp_mtcadc, "gate_isp_mtcadc", NULL, EXYNOS5430_ENABLE_IP_CAM10, 15, 0, 0),
	CGTE(gate_isp_wdt, "gate_isp_wdt", NULL, EXYNOS5430_ENABLE_IP_CAM10, 14, 0, 0),
	CGTE(gate_isp_pwm, "gate_isp_pwm", NULL, EXYNOS5430_ENABLE_IP_CAM10, 13, 0, 0),
	CGTE(gate_isp_uart, "gate_isp_uart", NULL, EXYNOS5430_ENABLE_IP_CAM10, 12, 0, 0),
	CGTE(gate_isp_mcuctl, "gate_isp_mcuctl", NULL, EXYNOS5430_ENABLE_IP_CAM10, 11, 0, 0),
	CGTE(gate_isp_spi1, "gate_isp_spi1", NULL, EXYNOS5430_ENABLE_IP_CAM10, 10, 0, 0),
	CGTE(gate_isp_spi0, "gate_isp_spi0", NULL, EXYNOS5430_ENABLE_IP_CAM10, 9, 0, 0),
	CGTE(gate_isp_i2c2, "gate_isp_i2c2", NULL, EXYNOS5430_ENABLE_IP_CAM10, 8, 0, 0),
	CGTE(gate_isp_i2c1, "gate_isp_i2c1", NULL, EXYNOS5430_ENABLE_IP_CAM10, 7, 0, 0),
	CGTE(gate_isp_i2c0, "gate_isp_i2c0", NULL, EXYNOS5430_ENABLE_IP_CAM10, 6, 0, 0),
	CGTE(gate_isp_mpwm, "gate_isp_mpwm", NULL, EXYNOS5430_ENABLE_IP_CAM10, 5, 0, 0),
	CGTE(gate_isp_gic, "gate_isp_gic", NULL, EXYNOS5430_ENABLE_IP_CAM10, 4, 0, 0),
	CGTE(gate_fd, "gate_fd", NULL, EXYNOS5430_ENABLE_IP_CAM10, 3, 0, 0),
	CGTE(gate_lite_c, "gate_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM10, 2, 0, 0),
	CGTE(gate_csis2, "gate_csis2", NULL, EXYNOS5430_ENABLE_IP_CAM10, 1, 0, 0),
	CGTE(gate_isp_ca5, "gate_isp_ca5", NULL, EXYNOS5430_ENABLE_IP_CAM10, 0, 0, 0),

	CGTE(gate_asyncapb_fd, "gate_asyncapb_fd", NULL, EXYNOS5430_ENABLE_IP_CAM11, 21, 0, 0),
	CGTE(gate_asyncapb_lite_c, "gate_asyncapb_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM11, 20, 0, 0),
	CGTE(gate_asyncahbs_sfrisp2h2, "gate_asyncahbs_sfrisp2h2", NULL, EXYNOS5430_ENABLE_IP_CAM11, 19, 0, 0),
	CGTE(gate_asyncahbs_sfrisp2h1, "gate_asyncahbs_sfrisp2h1", NULL, EXYNOS5430_ENABLE_IP_CAM11, 18, 0, 0),
	CGTE(gate_asyncaxi_ca5, "gate_asyncaxi_ca5", NULL, EXYNOS5430_ENABLE_IP_CAM11, 17, 0, 0),
	CGTE(gate_asyncaxi_ispx2, "gate_asyncaxi_ispx2", NULL, EXYNOS5430_ENABLE_IP_CAM11, 16, 0, 0),
	CGTE(gate_asyncaxi_ispx1, "gate_asyncaxi_ispx1", NULL, EXYNOS5430_ENABLE_IP_CAM11, 15, 0, 0),
	CGTE(gate_asyncaxi_ispx0, "gate_asyncaxi_ispx0", NULL, EXYNOS5430_ENABLE_IP_CAM11, 14, 0, 0),
	CGTE(gate_asyncaxi_ispex, "gate_asyncaxi_ispex", NULL, EXYNOS5430_ENABLE_IP_CAM11, 13, 0, 0),
	CGTE(gate_asyncaxi_isp3p, "gate_asyncaxi_isp3p", NULL, EXYNOS5430_ENABLE_IP_CAM11, 12, 0, 0),
	CGTE(gate_asyncaxi_fd, "gate_asyncaxi_fd", NULL, EXYNOS5430_ENABLE_IP_CAM11, 11, 0, 0),
	CGTE(gate_asyncaxi_lite_c, "gate_asyncaxi_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM11, 10, 0, 0),
	CGTE(gate_ahb2apb_isp5p, "gate_ahb2apb_isp5p", NULL, EXYNOS5430_ENABLE_IP_CAM11, 9, 0, 0),
	CGTE(gate_ahb2apb_isp3p, "gate_ahb2apb_isp3p", NULL, EXYNOS5430_ENABLE_IP_CAM11, 8, 0, 0),
	CGTE(gate_axi2apb_isp3p, "gate_axi2apb_isp3p", NULL, EXYNOS5430_ENABLE_IP_CAM11, 7, 0, 0),
	CGTE(gate_ahb_sfrisp2h, "gate_ahb_sfrisp2h", NULL, EXYNOS5430_ENABLE_IP_CAM11, 6, 0, 0),
	CGTE(gate_axi_isp_hx, "gate_axi_isp_hx", NULL, EXYNOS5430_ENABLE_IP_CAM11, 5, 0, 0),
	CGTE(gate_axi_isp_cx, "gate_axi_isp_cx", NULL, EXYNOS5430_ENABLE_IP_CAM11, 4, 0, 0),
	CGTE(gate_xiu_ispx, "gate_xiu_ispx", NULL, EXYNOS5430_ENABLE_IP_CAM11, 3, 0, 0),
	CGTE(gate_xiu_ispex, "gate_xiu_ispex", NULL, EXYNOS5430_ENABLE_IP_CAM11, 2, 0, 0),
	CGTE(gate_cam1np_333, "gate_cam1np_333", NULL, EXYNOS5430_ENABLE_IP_CAM11, 1, 0, 0),
	CGTE(gate_cam1nd_400, "gate_cam1nd_400", NULL, EXYNOS5430_ENABLE_IP_CAM11, 0, 0, 0),
	...
	CGTE(gate_qe_isp3p, "gate_qe_isp3p", NULL, EXYNOS5430_ENABLE_IP_CAM12, 7, 0, 0),
	CGTE(gate_qe_fd, "gate_qe_fd", NULL, EXYNOS5430_ENABLE_IP_CAM12, 6, 0, 0),
	CGTE(gate_qe_lite_c, "gate_qe_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM12, 5, 0, 0),
	CGTE(gate_ahbdn_sfrisp2h, "gate_ahbdn_sfrisp2h", NULL, EXYNOS5430_ENABLE_IP_CAM12, 4, 0, 0),
	CGTE(gate_ahbdn_isp5p, "gate_ahbdn_isp5p", NULL, EXYNOS5430_ENABLE_IP_CAM12, 3, 0, 0),
	CGTE(gate_axius_isp3p, "gate_axius_isp3p", NULL, EXYNOS5430_ENABLE_IP_CAM12, 2, 0, 0),
	CGTE(gate_axius_fd, "gate_axius_fd", NULL, EXYNOS5430_ENABLE_IP_CAM12, 1, 0, 0),
	CGTE(gate_axius_lite_c, "gate_axius_lite_c", NULL, EXYNOS5430_ENABLE_IP_CAM12, 0, 0, 0),

	CGTE(gate_isp_mtcadc_local, "gate_isp_mtcadc_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 14, 0, 0),
	CGTE(gate_isp_wdt_local, "gate_isp_wdt_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 13, 0, 0),
	CGTE(gate_isp_pwm_local, "gate_isp_pwm_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 12, 0, 0),
	CGTE(gate_isp_uart_local, "gate_isp_uart_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 11, 0, 0),
	CGTE(gate_isp_mcuctl_local, "gate_isp_mcuctl_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 10, 0, 0),
	CGTE(gate_isp_spi1_local, "gate_isp_spi1_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 9, 0, 0),
	CGTE(gate_isp_spi0_local, "gate_isp_spi0_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 8, 0, 0),
	CGTE(gate_isp_i2c2_local, "gate_isp_i2c2_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 7, 0, 0),
	CGTE(gate_isp_i2c1_local, "gate_isp_i2c1_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 6, 0, 0),
	CGTE(gate_isp_i2c0_local, "gate_isp_i2c0_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 5, 0, 0),
	CGTE(gate_isp_mpwm_local, "gate_isp_mpwm_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 4, 0, 0),
	CGTE(gate_isp_gic_local, "gate_isp_gic_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 3, 0, 0),
	CGTE(gate_fd_local, "gate_fd_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 2, 0, 0),
	CGTE(gate_lite_c_local, "gate_lite_c_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 1, 0, 0),
	CGTE(gate_csis2_local, "gate_csis2_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL0, 0, 0, 0),

	CGTE(gate_lite_c_freecnt_local, "gate_lite_c_freecnt_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL1, 2, 0, 0),
	CGTE(gate_pixelasyncm_fd_local, "gate_pixelasyncm_fd_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL1, 1, 0, 0),
	CGTE(gate_pixelasyncs_lite_c_local, "gate_pixelasyncs_lite_c_local", NULL, EXYNOS5430_ENABLE_IP_CAM1_LOCAL1, 0, 0, 0),

	/* ISP */
	CGTE(gate_isp_d_glue, "gate_isp_d_glue", NULL, EXYNOS5430_ENABLE_IP_ISP0, 9, 0, 0),
	CGTE(gate_pmu_isp, "gate_pmu_isp", NULL, EXYNOS5430_ENABLE_IP_ISP0, 8, 0, 0),
	CGTE(gate_sysreg_isp, "gate_sysreg_isp", NULL, EXYNOS5430_ENABLE_IP_ISP0, 7, 0, 0),
	CGTE(gate_cmu_isp_local, "gate_cmu_isp_local", NULL, EXYNOS5430_ENABLE_IP_ISP0, 6, 0, 0),
	CGTE(gate_scalerp, "gate_scalerp", NULL, EXYNOS5430_ENABLE_IP_ISP0, 5, 0, 0),
	CGTE(gate_3dnr, "gate_3dnr", NULL, EXYNOS5430_ENABLE_IP_ISP0, 4, 0, 0),
	CGTE(gate_dis, "gate_dis", NULL, EXYNOS5430_ENABLE_IP_ISP0, 3, 0, 0),
	CGTE(gate_scalerc, "gate_scalerc", NULL, EXYNOS5430_ENABLE_IP_ISP0, 2, 0, 0),
	CGTE(gate_drc, "gate_drc", NULL, EXYNOS5430_ENABLE_IP_ISP0, 1, 0, 0),
	CGTE(gate_isp, "gate_isp", NULL, EXYNOS5430_ENABLE_IP_ISP0, 0, 0, 0),

	CGTE(gate_axius_scalerp, "gate_axius_scalerp", NULL, EXYNOS5430_ENABLE_IP_ISP1, 15, 0, 0),
	CGTE(gate_axius_scalerc, "gate_axius_scalerc", NULL, EXYNOS5430_ENABLE_IP_ISP1, 14, 0, 0),
	CGTE(gate_axius_drc, "gate_axius_drc", NULL, EXYNOS5430_ENABLE_IP_ISP1, 13, 0, 0),
	CGTE(gate_asyncahbm_isp2p, "gate_asyncahbm_isp2p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 12, 0, 0),
	CGTE(gate_asyncahbm_isp1p, "gate_asyncahbm_isp1p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 11, 0, 0),
	CGTE(gate_asyncaxi_dis1, "gate_asyncaxi_dis1", NULL, EXYNOS5430_ENABLE_IP_ISP1, 10, 0, 0),
	CGTE(gate_asyncaxi_dis0, "gate_asyncaxi_dis0", NULL, EXYNOS5430_ENABLE_IP_ISP1, 9, 0, 0),
	CGTE(gate_asyncaxim_isp2p, "gate_asyncaxim_isp2p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 8, 0, 0),
	CGTE(gate_asyncaxim_isp1p, "gate_asyncaxim_isp1p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 7, 0, 0),
	CGTE(gate_ahb2apb_isp2p, "gate_ahb2apb_isp2p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 6, 0, 0),
	CGTE(gate_ahb2apb_isp1p, "gate_ahb2apb_isp1p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 5, 0, 0),
	CGTE(gate_axi2apb_isp2p, "gate_axi2apb_isp2p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 4, 0, 0),
	CGTE(gate_axi2apb_isp1p, "gate_axi2apb_isp1p", NULL, EXYNOS5430_ENABLE_IP_ISP1, 3, 0, 0),
	CGTE(gate_xiu_ispex1, "gate_xiu_ispex1", NULL, EXYNOS5430_ENABLE_IP_ISP1, 2, 0, 0),
	CGTE(gate_xiu_ispex0, "gate_xiu_ispex0", NULL, EXYNOS5430_ENABLE_IP_ISP1, 1, 0, 0),
	CGTE(gate_ispnd_400, "gate_ispnd_400", NULL, EXYNOS5430_ENABLE_IP_ISP1, 0, 0, 0),
	...
	CGTE(gate_qe_scalerp, "gate_qe_scalerp", NULL, EXYNOS5430_ENABLE_IP_ISP2, 6, 0, 0),
	CGTE(gate_qe_3dnr, "gate_qe_3dnr", NULL, EXYNOS5430_ENABLE_IP_ISP2, 5, 0, 0),
	CGTE(gate_qe_dis1, "gate_qe_dis1", NULL, EXYNOS5430_ENABLE_IP_ISP2, 4, 0, 0),
	CGTE(gate_qe_dis0, "gate_qe_dis0", NULL, EXYNOS5430_ENABLE_IP_ISP2, 3, 0, 0),
	CGTE(gate_qe_scalerc, "gate_qe_scalerc", NULL, EXYNOS5430_ENABLE_IP_ISP2, 2, 0, 0),
	CGTE(gate_qe_drc, "gate_qe_drc", NULL, EXYNOS5430_ENABLE_IP_ISP2, 1, 0, 0),
	CGTE(gate_qe_isp, "gate_qe_isp", NULL, EXYNOS5430_ENABLE_IP_ISP2, 0, 0, 0),

	CGTE(gate_pixelasync_dis, "gate_pixelasync_dis", NULL, EXYNOS5430_ENABLE_IP_ISP3, 3, 0, 0),
	CGTE(gate_pixelasyncs_scalerp, "gate_pixelasyncs_scalerp", NULL, EXYNOS5430_ENABLE_IP_ISP3, 2, 0, 0),
	CGTE(gate_pixelasyncm_ispd, "gate_pixelasyncm_ispd", NULL, EXYNOS5430_ENABLE_IP_ISP3, 1, 0, 0),
	CGTE(gate_pixelasync_ispc, "gate_pixelasync_ispc", NULL, EXYNOS5430_ENABLE_IP_ISP3, 0, 0, 0),
	...
	CGTE(dout_mem0_pll, "dout_mem0_pll", "mout_mem0_pll", EXYNOS5430_ENABLE_ACLK_MIF0, 0, 0, 0),
	CGTE(dout_mem1_pll, "dout_mem1_pll", "mout_mem1_pll", EXYNOS5430_ENABLE_ACLK_MIF0, 0, 0, 0),
	CGTE(dout_mfc_pll, "dout_mfc_pll", "mout_mfc_pll", EXYNOS5430_ENABLE_ACLK_MIF0, 0, 0, 0),
	CGTE(dout_bus_pll, "dout_bus_pll", "mout_bus_pll", EXYNOS5430_ENABLE_ACLK_MIF0, 0, 0, 0),
};
