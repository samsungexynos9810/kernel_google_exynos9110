...
struct samsung_mux_clock exynos5433_mux_clks[] __initdata = {
	...
	CMX_STAT(mout_aclk_mfc_400_a, EXYNOS5430_SRC_SEL_TOP4, 0, 1, EXYNOS5430_SRC_STAT_TOP4, 0, 3),
...
struct samsung_div_clock exynos5433_div_clks[] __initdata = {
	...
	CDIV(dout_aclk_bus0_400, "mout_bus_pll_user", EXYNOS5430_DIV_TOP4, 4, 3),
	...
	/* DIV clocks for MIF */
	CDIV(dout_aclk_mif_266, "mout_bus_pll_div2", EXYNOS5430_DIV_MIF2, 20, 3),
	/* DIV clocks for G3D */
