 ...
 *
 * Common Clock Framework support for Exynos7270 SoC.
*/
...
static struct samsung_fixed_rate exynos7270_fixed_rate_ext_clks[] __initdata = {
	FRATE(oscclk, "fin_pll", NULL, CLK_IS_ROOT, 26000000),
};

static struct init_vclk exynos7270_mif_vclks[] __initdata = {
...
static struct init_vclk exynos7270_g3d_vclks[] __initdata = {
...
static struct init_vclk exynos7270_peri_vclks[] __initdata = {
...
static struct init_vclk exynos7270_fsys_vclks[] __initdata = {
...
static struct init_vclk exynos7270_mfcmscl_vclks[] __initdata = {
...
static struct init_vclk exynos7270_dispaud_vclks[] __initdata = {
...
static struct init_vclk exynos7270_isp_vclks[] __initdata = {
...
static struct init_vclk exynos7270_apm_vclks[] __initdata = {
	VCLK(gate_apm, gate_apm_apm, "gate_apm_apm", 0, 0, NULL),
};

static struct of_device_id ext_clk_match[] __initdata = {
	{ .compatible = "samsung,exynos7270-oscclk", .data = (void *)0, },
};

static struct init_vclk exynos7270_dfs_vclks[] __initdata = {
	/* DFS */
...
static struct init_vclk exynos7270_clkout_vclks[] __initdata = {
	VCLK(oscclk_aud, pxmxdx_oscclk_aud, "pxmxdx_oscclk_aud", 0, 0, NULL),
};

/* register exynos7270 clocks */
void __init exynos7270_clk_init(struct device_node *np)
{
	...
	samsung_register_of_fixed_ext(ctx, exynos7270_fixed_rate_ext_clks,
			ARRAY_SIZE(exynos7270_fixed_rate_ext_clks), ext_clk_match);

	samsung_register_vclk(ctx, exynos7270_mif_vclks, ARRAY_SIZE(exynos7270_mif_vclks));
	samsung_register_vclk(ctx, exynos7270_g3d_vclks, ARRAY_SIZE(exynos7270_g3d_vclks));
	samsung_register_vclk(ctx, exynos7270_peri_vclks, ARRAY_SIZE(exynos7270_peri_vclks));
	samsung_register_vclk(ctx, exynos7270_fsys_vclks, ARRAY_SIZE(exynos7270_fsys_vclks));
	samsung_register_vclk(ctx, exynos7270_mfcmscl_vclks, ARRAY_SIZE(exynos7270_mfcmscl_vclks));
	samsung_register_vclk(ctx, exynos7270_dispaud_vclks, ARRAY_SIZE(exynos7270_dispaud_vclks));
	samsung_register_vclk(ctx, exynos7270_isp_vclks, ARRAY_SIZE(exynos7270_isp_vclks));
	samsung_register_vclk(ctx, exynos7270_apm_vclks, ARRAY_SIZE(exynos7270_apm_vclks));
	samsung_register_vclk(ctx, exynos7270_dfs_vclks, ARRAY_SIZE(exynos7270_dfs_vclks));
	samsung_register_vclk(ctx, exynos7270_clkout_vclks, ARRAY_SIZE(exynos7270_clkout_vclks));
...
CLK_OF_DECLARE(exynos7270_clk, "samsung,exynos7270-clock", exynos7270_clk_init);
